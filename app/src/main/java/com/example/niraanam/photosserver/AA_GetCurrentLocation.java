...
import java.util.Locale;
    ...
    public class AA_GetCurrentLocation extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
        LocationRequest locationRequest;
        GoogleApiClient googleApiClient;
        TextView textView,txtDMS;

        @Override
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.aa_getcurrentlocation);
            ...
            Button button = button = (Button) findViewById(R.id.button1);
